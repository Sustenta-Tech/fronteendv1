...
function Sobre() {
    ...
    return (
        <>
            ...
            <Grid md={12} container direction="row" justifyContent="center" alignItems="center" className='cardmissao' style={{ backgroundColor: theme.palette.background.paper}}>
                <Grid item md={6}>
                    <Box paddingX={5} textAlign={'center'}>
            ...
            <Grid md={12} container direction="row" justifyContent="center" alignItems="center" className='titulo' style={{ backgroundColor: theme.palette.background.default }}>
                <Grid alignItems="center" item md={6}>
                    <Box>
                ...
                <Grid item md={6} style={{ color: theme.palette.secondary.contrastText}}>
                    <Box paddingX={5} textAlign={'center'}>
